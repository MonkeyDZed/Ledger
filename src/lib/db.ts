...
async function applyMigrations(db: Database) {
    ...
    // ✅ Correct path: migrations/ at project root
...
/**
 * Récupère les informations de configuration de la base de données
 * Utile pour debugging et monitoring de performance
 */
export async function getDatabaseInfo() {
    ...
    const info = {
        ...
        mmap_size: await db.get('PRAGMA mmap_size'),
        busy_timeout: await db.get('PRAGMA busy_timeout'),
