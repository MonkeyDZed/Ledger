        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card>
                <CardContent className="flex items-center p-6">
                    ...
                    <div className="ml-4">
                        <p className="text-sm font-medium text-gray-600">{dashboard.suppliers}</p>
            ...
            <Card>
                <CardContent className="flex items-center p-6">
                    ...
                    <div className="ml-4">
                        <p className="text-sm font-medium text-gray-600">{dashboard.pieces}</p>
            ...
            <Card>
                <CardContent className="flex items-center p-6">
                    ...
                    <div className="ml-4">
                        <p className="text-sm font-medium text-gray-600">{dashboard.totalDebts}</p>
            ...
            <Card>
                 <CardContent className="flex items-center p-6">
                    ...
                    <div className="ml-4">
                        <p className="text-sm font-medium text-gray-600">{dashboard.lastSync}</p>
                        <p className="text-2xl font-semibold text-gray-900">{dashboard.upToDate}</p>
                    </div>
                </CardContent>
            </Card>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
                ...
                <Card className="mb-8">
                    <CardHeader>
                        <div className="flex justify-between items-center">
                            <h2 className="text-lg font-semibold text-gray-900">{dashboard.quickActions}</h2>
                            <Link href="#" className="text-sm text-primary font-medium">{dashboard.seeAll}</Link>
                        </div>
                    </CardHeader>
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <QuickActionButton className="bg-blue-100 text-primary" icon={<UserPlusIcon />} label={dashboard.addSupplier} />
                            <QuickActionButton className="bg-green-100 text-secondary" icon={<FileInvoiceDollarIcon />} label={dashboard.newPiece} />
                            <QuickActionButton className="bg-amber-100 text-amber-500" icon={<FileExportIcon />} label={dashboard.export} />
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card>
                    <CardHeader>
                        <div className="flex justify-between items-center">
                            <h2 className="text-lg font-semibold text-gray-900">{dashboard.recentSuppliers}</h2>
                            <Link href={`/${lang}/suppliers`} className="text-sm text-primary font-medium">{dashboard.seeAll}</Link>
                        </div>
                    </CardHeader>
                    <CardContent>
                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow className="bg-gray-50">
                                        <TableHead>{dashboard.supplierName}</TableHead>
                                        <TableHead>{dashboard.wilaya}</TableHead>
                                        <TableHead>{dashboard.totalInvoiced}</TableHead>
                                        <TableHead>{dashboard.remaining}</TableHead>
                                        <TableHead>{dashboard.action}</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
                                          ...
                                          <TableCell>
                                              <div className="flex items-center">
                                                  ...
                                                  <div className="ml-4">
                                                      ...
                                                      <div className="text-sm text-gray-500">{dashboard.nif}: {supplier.nif}</div>
                                                  </div>
                                              </div>
                                          </TableCell>
            ...
            <div className="lg:col-span-1">
                ...
                <Card className="mb-8">
                     <CardHeader>
                        <h2 className="text-lg font-semibold text-gray-900">{dashboard.financialOverview}</h2>
                    </CardHeader>
                    <CardContent>
                        ...
                        <div className="space-y-4 mt-6">
                            <div>
                                <div className="flex justify-between mb-1">
                                    <span className="text-sm font-medium text-gray-700 flex items-center"><span className="w-2 h-2 rounded-full bg-chart-2 mr-2"></span>{dashboard.paid}</span>
                            ...
                            <div>
                                <div className="flex justify-between mb-1">
                                    <span className="text-sm font-medium text-gray-700 flex items-center"><span className="w-2 h-2 rounded-full bg-chart-4 mr-2"></span>{dashboard.toPay}</span>
