...
export async function addPiece(data: PieceFormValues, lang: string) : Promise<{success: boolean, message?: string}> {
    ...
    try {
        ...
        revalidatePath(`/${lang}/suppliers/${validation.data.supplier_id}`);
